...
const CreateAccountForm: React.FC<CreateAccountFormProps> = ({ onSubmit }) => {
    ...
    const accountTypes: ACCOUNT_TYPE[] = ["BANK", "BANK_OD", "CASH_COUNTER", "CHEQUE", "MISC"];
    ...
    return (
        <form
            ...
            className="space-y-6 w-full max-w-2xl mx-auto bg-card shadow-md rounded-lg p-8"
        >
            ...
            {(accountType === "BANK" || accountType === "BANK_OD") && (
                <>
                    <div className="space-y-2">
                        ...
                        <Input
                            id="details.bankName"
                            {...register("details.bankName", { required: "Bank name is required" })}
                        />
